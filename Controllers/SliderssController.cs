...
namespace Gameapp.Controllers
{
    ...
    public class SliderssController : Controller
    {
        private GamesContext _context;

        public SliderssController(GamesContext context)
        {
            _context = context;
        }
        ...
        [HttpGet]
        public async Task<IActionResult> ChampionLookup(DataSourceLoadOptions loadOptions)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> BannerLookup(DataSourceLoadOptions loadOptions)
        {
