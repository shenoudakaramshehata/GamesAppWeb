...
namespace Gameapp.Areas.Shop.Pages.Items
{
    ...
    public class ItemsModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(Gameapp.Models.Items Item)
        {
            ...
            var lastSubscription = _context.Subscriptions.Include(q => q.Plan).Where(s => s.ShopId == shopID).OrderBy(i => i.Id).LastOrDefault();
            ...
            var itemCountry = _context.Shop.FirstOrDefault(s => s.ShopId == shopId).CountryId;
