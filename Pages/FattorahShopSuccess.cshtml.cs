...
{
    public class FattorahShopSuccessModel : PageModel
    {
        ...
        public FattorahShopSuccessModel(GamesContext context, IEmailSender emailSender, IConfiguration configuration)
        {
            _context = context;
