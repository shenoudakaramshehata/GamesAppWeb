...
namespace Gameapp.Pages
{
    public class FattorahSuccessModel : PageModel
    {
        ...
        public FattorahSuccessModel(GamesContext context, IEmailSender emailSender, UserManager<ApplicationUser> userManager, Microsoft.AspNetCore.Hosting.IHostingEnvironment env, IConfiguration configuration)
        {
            _context = context;
